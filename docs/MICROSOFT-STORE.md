...
Application version is centralized in `Directory.Build.props` (`<Version>`). Current release: **1.5.18** (see `CHANGELOG.md`).
...
Example: `_store_out\CaveAiProForWindows-1.5.18-Store-unsigned.msix`

Review certification example: `_store_out\CaveAiProForWindows-1.5.18-Store-Review-unsigned.msix`
